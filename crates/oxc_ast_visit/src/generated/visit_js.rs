...
pub mod walk_js {
    ...
    #[inline]
    pub fn walk_leading_dot_expression<'a, V: VisitJs<'a>>(
        visitor: &mut V,
    ...
    #[inline]
    pub fn walk_import_meta<'a, V: VisitJs<'a>>(visitor: &mut V, it: &ImportMeta) {
    ...
    #[inline]
    pub fn walk_new_target<'a, V: VisitJs<'a>>(visitor: &mut V, it: &NewTarget) {
    ...
    #[inline]
    pub fn walk_lazy_import_declaration<'a, V: VisitJs<'a>>(
        visitor: &mut V,
    ...
    #[inline]
    pub fn walk_struct_statement<'a, V: VisitJs<'a>>(visitor: &mut V, it: &StructStatement<'a>) {
    ...
    #[inline]
    pub fn walk_struct_body<'a, V: VisitJs<'a>>(visitor: &mut V, it: &StructBody<'a>) {
    ...
    #[inline]
    pub fn walk_struct_element<'a, V: VisitJs<'a>>(visitor: &mut V, it: &StructElement<'a>) {
        // No `AstKind` for this type
        match it {
    ...
    #[inline]
    pub fn walk_ark_ui_component_expression<'a, V: VisitJs<'a>>(
        visitor: &mut V,
    ...
    #[inline]
    pub fn walk_ark_ui_child<'a, V: VisitJs<'a>>(visitor: &mut V, it: &ArkUIChild<'a>) {
        // No `AstKind` for this type
        match it {
    ...
    #[inline]
    pub fn walk_annotation_declaration<'a, V: VisitJs<'a>>(
        visitor: &mut V,
    ...
    #[inline]
    pub fn walk_annotation_body<'a, V: VisitJs<'a>>(visitor: &mut V, it: &AnnotationBody<'a>) {
    ...
    #[inline]
    pub fn walk_annotation_element<'a, V: VisitJs<'a>>(
        visitor: &mut V,
        it: &AnnotationElement<'a>,
    ) {
        // No `AstKind` for this type
        match it {
    ...
    #[inline]
    pub fn walk_struct_elements<'a, V: VisitJs<'a>>(
        visitor: &mut V,
    ...
    #[inline]
    pub fn walk_ark_ui_children<'a, V: VisitJs<'a>>(
        visitor: &mut V,
    ...
    #[inline]
    pub fn walk_call_expressions<'a, V: VisitJs<'a>>(
        visitor: &mut V,
    ...
    #[inline]
    pub fn walk_annotation_elements<'a, V: VisitJs<'a>>(
        visitor: &mut V,
