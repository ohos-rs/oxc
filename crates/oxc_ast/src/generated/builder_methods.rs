...
impl<'a> Expression<'a> {
    ...
    /// * `body`: The function body.
    #[inline]
    pub fn new_function_expression_with_decorators<B: GetAstBuilder<'a>, T1, T2, T3, T4, T5>(
        span: Span,
        r#type: FunctionType,
    ...
    where
        ...
        T5: IntoIn<'a, Option<ArenaBox<'a, FunctionBody<'a>>>>,
    {
        Self::FunctionExpression(Function::boxed_with_decorators(
            span,
            r#type,
            decorators,
            id,
    ...
    /// * `pife`: `true` if the function should be marked as "Possibly-Invoked Function Expression" (PIFE).
    #[inline]
    pub fn new_function_expression_with_scope_id_and_pure_and_pife_with_decorators<
        B: GetAstBuilder<'a>,
        T1,
        T2,
        T3,
    ...
    where
        ...
        T5: IntoIn<'a, Option<ArenaBox<'a, FunctionBody<'a>>>>,
    {
        Self::FunctionExpression(Function::boxed_with_scope_id_and_pure_and_pife_with_decorators(
            span,
            r#type,
            decorators,
            id,
    ...
    #[inline]
    pub fn new_ark_ui_component_expression<B: GetAstBuilder<'a>, T1, T2, T3, T4>(
        span: Span,
        callee: Expression<'a>,
        type_arguments: T1,
        arguments: T2,
        children: T3,
        has_children: bool,
        chain_expressions: T4,
        builder: &B,
    ) -> Self
    where
        T1: IntoIn<'a, Option<ArenaBox<'a, TSTypeParameterInstantiation<'a>>>>,
        T2: IntoIn<'a, ArenaVec<'a, Argument<'a>>>,
        T3: IntoIn<'a, ArenaVec<'a, ArkUIChild<'a>>>,
        T4: IntoIn<'a, ArenaVec<'a, CallExpression<'a>>>,
    {
        Self::ArkUIComponentExpression(ArkUIComponentExpression::boxed(
            span,
            callee,
            type_arguments,
            arguments,
    ...
    #[inline]
    pub fn new_leading_dot_expression<B: GetAstBuilder<'a>, T1, T2>(
        span: Span,
        optional: bool,
        type_arguments: T1,
        arguments: T2,
    ...
    where
        ...
        T2: IntoIn<'a, ArenaVec<'a, Argument<'a>>>,
    {
        Self::LeadingDotExpression(LeadingDotExpression::boxed(
            span,
            optional,
            type_arguments,
            arguments,
...
impl<'a> ArrayExpressionElement<'a> {
    ...
    /// Build an [`ArrayExpressionElement::FunctionExpression`] with `decorators`.
    ///
    /// This node contains a [`Function`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build an [`ArrayExpressionElement::FunctionExpression`] with `scope_id` and `pure` and `pife` and `decorators`.
    ///
    /// This node contains a [`Function`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build an [`ArrayExpressionElement::ArkUIComponentExpression`].
    ///
    /// This node contains an [`ArkUIComponentExpression`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build an [`ArrayExpressionElement::LeadingDotExpression`].
    ///
    /// This node contains a [`LeadingDotExpression`] that will be stored in the memory arena.
    ///
    /// ## Parameters
...
impl<'a> PropertyKey<'a> {
    ...
    /// Build a [`PropertyKey::FunctionExpression`] with `decorators`.
    ///
    /// This node contains a [`Function`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build a [`PropertyKey::FunctionExpression`] with `scope_id` and `pure` and `pife` and `decorators`.
    ///
    /// This node contains a [`Function`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build a [`PropertyKey::ArkUIComponentExpression`].
    ///
    /// This node contains an [`ArkUIComponentExpression`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build a [`PropertyKey::LeadingDotExpression`].
    ///
    /// This node contains a [`LeadingDotExpression`] that will be stored in the memory arena.
    ///
    /// ## Parameters
...
impl<'a> LeadingDotExpression<'a> {
    /// Build a [`LeadingDotExpression`].
    ///
    /// If you want the built node to be allocated in the memory arena,
    /// use [`LeadingDotExpression::boxed`] instead.
    ///
    /// ## Parameters
    /// * `span`: The [`Span`] covering this node
    /// * `optional`
    ...
    ///
    /// Returns a [`Box`](ArenaBox) containing the newly-allocated node.
    /// If you want a stack-allocated node, use [`LeadingDotExpression::new`] instead.
    ///
    /// ## Parameters
    /// * `span`: The [`Span`] covering this node
    /// * `optional`
    ...
    {
        ArenaBox::new_in(
            Self::new(span, optional, type_arguments, arguments, expression, builder),
            builder.builder(),
        )
    }
}
...
impl<'a> Argument<'a> {
    ...
    /// Build an [`Argument::FunctionExpression`] with `decorators`.
    ///
    /// This node contains a [`Function`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build an [`Argument::FunctionExpression`] with `scope_id` and `pure` and `pife` and `decorators`.
    ///
    /// This node contains a [`Function`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build an [`Argument::ArkUIComponentExpression`].
    ///
    /// This node contains an [`ArkUIComponentExpression`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build an [`Argument::LeadingDotExpression`].
    ///
    /// This node contains a [`LeadingDotExpression`] that will be stored in the memory arena.
    ///
    /// ## Parameters
...
impl<'a> Statement<'a> {
    ...
    /// Build a [`Statement::FunctionDeclaration`] with `decorators`.
    ///
    /// This node contains a [`Function`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// * `body`: The function body.
    #[inline]
    pub fn new_function_declaration_with_decorators<B: GetAstBuilder<'a>, T1, T2, T3, T4, T5>(
        span: Span,
        r#type: FunctionType,
        decorators: ArenaVec<'a, Decorator<'a>>,
        id: Option<BindingIdentifier<'a>>,
    ...
    where
        ...
        T5: IntoIn<'a, Option<ArenaBox<'a, FunctionBody<'a>>>>,
    {
        Self::FunctionDeclaration(Function::boxed_with_decorators(
            span,
            r#type,
            decorators,
            id,
    ...
    /// Build a [`Statement::FunctionDeclaration`] with `scope_id` and `pure` and `pife` and `decorators`.
    ///
    /// This node contains a [`Function`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// * `pife`: `true` if the function should be marked as "Possibly-Invoked Function Expression" (PIFE).
    #[inline]
    pub fn new_function_declaration_with_scope_id_and_pure_and_pife_with_decorators<
        B: GetAstBuilder<'a>,
        T1,
        T2,
        T3,
    ...
    where
        ...
        T5: IntoIn<'a, Option<ArenaBox<'a, FunctionBody<'a>>>>,
    {
        Self::FunctionDeclaration(Function::boxed_with_scope_id_and_pure_and_pife_with_decorators(
            span,
            r#type,
            decorators,
            id,
    ...
    #[inline]
    pub fn new_struct_statement<B: GetAstBuilder<'a>, T1, T2, T3, T4, T5>(
        span: Span,
        decorators: T1,
        id: BindingIdentifier<'a>,
        type_parameters: T2,
    ...
    where
        ...
        T3: IntoIn<'a, Option<ArenaBox<'a, TSTypeParameterInstantiation<'a>>>>,
        T4: IntoIn<'a, ArenaVec<'a, TSClassImplements<'a>>>,
        T5: IntoIn<'a, ArenaBox<'a, StructBody<'a>>>,
    {
        Self::StructStatement(StructStatement::boxed(
            span,
            decorators,
            id,
            type_parameters,
    ...
    #[inline]
    pub fn new_struct_statement_with_scope_id<B: GetAstBuilder<'a>, T1, T2, T3, T4, T5>(
        span: Span,
        decorators: T1,
        id: BindingIdentifier<'a>,
        type_parameters: T2,
    ...
    where
        ...
        T5: IntoIn<'a, ArenaBox<'a, StructBody<'a>>>,
    {
        Self::StructStatement(StructStatement::boxed_with_scope_id(
            span,
            decorators,
            id,
            type_parameters,
    ...
    /// Build a [`Statement::AnnotationDeclaration`].
    ///
    ...
    #[inline]
    pub fn new_annotation_declaration<B: GetAstBuilder<'a>, T1, T2>(
        span: Span,
        decorators: T1,
        id: BindingIdentifier<'a>,
        body: T2,
    ...
    where
        T1: IntoIn<'a, ArenaVec<'a, Decorator<'a>>>,
        T2: IntoIn<'a, ArenaBox<'a, AnnotationBody<'a>>>,
    {
        Self::AnnotationDeclaration(AnnotationDeclaration::boxed(
            span, decorators, id, body, declare, builder,
        ))
    }

    /// Build a [`Statement::AnnotationDeclaration`] with `scope_id`.
    ///
    /// This node contains an [`AnnotationDeclaration`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    #[inline]
    pub fn new_annotation_declaration_with_scope_id<B: GetAstBuilder<'a>, T1, T2>(
        span: Span,
        decorators: T1,
        id: BindingIdentifier<'a>,
        body: T2,
    ...
    /// Build a [`Statement::LazyImportDeclaration`].
    ///
    ...
    /// * `with_clause`: Some(vec![]) for empty assertion
    #[inline]
    pub fn new_lazy_import_declaration<B: GetAstBuilder<'a>, T1>(
        span: Span,
        specifiers: Option<ArenaVec<'a, ImportDeclarationSpecifier<'a>>>,
        source: StringLiteral<'a>,
        with_clause: T1,
    ...
    where
        T1: IntoIn<'a, Option<ArenaBox<'a, WithClause<'a>>>>,
    {
        Self::LazyImportDeclaration(LazyImportDeclaration::boxed(
            span,
            specifiers,
            source,
            with_clause,
    ...
    /// Build a [`Statement::ExportNamedDeclaration`] with `decorators`.
    ///
    /// This node contains an [`ExportNamedDeclaration`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// * `with_clause`: Some(vec![]) for empty assertion
    #[inline]
    pub fn new_export_named_declaration_with_decorators<B: GetAstBuilder<'a>, T1, T2>(
        span: Span,
        decorators: ArenaVec<'a, Decorator<'a>>,
        declaration: Option<Declaration<'a>>,
        specifiers: T1,
    ...
    where
        ...
        T2: IntoIn<'a, Option<ArenaBox<'a, WithClause<'a>>>>,
    {
        Self::ExportNamedDeclaration(ExportNamedDeclaration::boxed_with_decorators(
            span,
            decorators,
            declaration,
            specifiers,
...
impl<'a> Declaration<'a> {
    ...
    /// Build a [`Declaration::StructStatement`].
    ///
    /// This node contains a [`StructStatement`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build a [`Declaration::StructStatement`] with `scope_id`.
    ///
    /// This node contains a [`StructStatement`] that will be stored in the memory arena.
    ///
    /// ## Parameters
...
impl<'a> ForStatementInit<'a> {
    ...
    /// Build a [`ForStatementInit::FunctionExpression`] with `decorators`.
    ///
    /// This node contains a [`Function`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build a [`ForStatementInit::FunctionExpression`] with `scope_id` and `pure` and `pife` and `decorators`.
    ///
    /// This node contains a [`Function`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build a [`ForStatementInit::ArkUIComponentExpression`].
    ///
    /// This node contains an [`ArkUIComponentExpression`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build a [`ForStatementInit::LeadingDotExpression`].
    ///
    /// This node contains a [`LeadingDotExpression`] that will be stored in the memory arena.
    ///
    /// ## Parameters
...
impl<'a> Function<'a> {
        ...
        T5: IntoIn<'a, Option<ArenaBox<'a, FunctionBody<'a>>>>,
    {
        ...
        Function {
            ...
            span,
            r#type,
            decorators: ArenaVec::new_in(builder),
            id,
            generator,
            r#async,
            declare,
    ...
    ///
    /// If you want the built node to be allocated in the memory arena,
    /// use [`Function::boxed_with_decorators`] instead.
    ///
    /// ## Parameters
    /// * `span`: The [`Span`] covering this node
    /// * `type`
    ...
    /// * `body`: The function body.
    #[inline]
    pub fn new_with_decorators<B: GetAstBuilder<'a>, T1, T2, T3, T4, T5>(
        span: Span,
        r#type: FunctionType,
        decorators: ArenaVec<'a, Decorator<'a>>,
        id: Option<BindingIdentifier<'a>>,
    ...
    ///
    /// Returns a [`Box`](ArenaBox) containing the newly-allocated node.
    /// If you want a stack-allocated node, use [`Function::new_with_decorators`] instead.
    ///
    /// ## Parameters
    /// * `span`: The [`Span`] covering this node
    /// * `type`
    ...
    /// * `body`: The function body.
    #[inline]
    pub fn boxed_with_decorators<B: GetAstBuilder<'a>, T1, T2, T3, T4, T5>(
        span: Span,
        r#type: FunctionType,
        decorators: ArenaVec<'a, Decorator<'a>>,
        id: Option<BindingIdentifier<'a>>,
    ...
    ///
    /// If you want the built node to be allocated in the memory arena,
    /// use [`Function::boxed_with_scope_id_and_pure_and_pife_with_decorators`] instead.
    ///
    /// ## Parameters
    /// * `span`: The [`Span`] covering this node
    /// * `type`
    ...
    /// * `pife`: `true` if the function should be marked as "Possibly-Invoked Function Expression" (PIFE).
    #[inline]
    pub fn new_with_scope_id_and_pure_and_pife_with_decorators<
        B: GetAstBuilder<'a>,
        T1,
        T2,
        T3,
    ...
    ///
    /// Returns a [`Box`](ArenaBox) containing the newly-allocated node.
    /// If you want a stack-allocated node, use [`Function::new_with_scope_id_and_pure_and_pife_with_decorators`] instead.
    ///
    /// ## Parameters
    /// * `span`: The [`Span`] covering this node
    /// * `type`
    ...
    /// * `pife`: `true` if the function should be marked as "Possibly-Invoked Function Expression" (PIFE).
    #[inline]
    pub fn boxed_with_scope_id_and_pure_and_pife_with_decorators<
        B: GetAstBuilder<'a>,
        T1,
        T2,
        T3,
    ...
    {
        ArenaBox::new_in(
            Self::new_with_scope_id_and_pure_and_pife_with_decorators(
                span,
                r#type,
                decorators,
                id,
...
impl<'a> LazyImportDeclaration<'a> {
    /// Build a [`LazyImportDeclaration`].
    ///
    /// If you want the built node to be allocated in the memory arena,
    /// use [`LazyImportDeclaration::boxed`] instead.
    ///
    /// ## Parameters
    /// * `span`: The [`Span`] covering this node
    /// * `specifiers`: Import specifiers (e.g., `{ c }`)
    ...
    ///
    /// Returns a [`Box`](ArenaBox) containing the newly-allocated node.
    /// If you want a stack-allocated node, use [`LazyImportDeclaration::new`] instead.
    ///
    /// ## Parameters
    /// * `span`: The [`Span`] covering this node
    /// * `specifiers`: Import specifiers (e.g., `{ c }`)
    ...
    {
        ArenaBox::new_in(
            Self::new(span, specifiers, source, with_clause, builder),
            builder.builder(),
        )
    }
}
...
impl<'a> ExportNamedDeclaration<'a> {
    ...
    ///
    /// If you want the built node to be allocated in the memory arena,
    /// use [`ExportNamedDeclaration::boxed_with_decorators`] instead.
    ///
    /// ## Parameters
    /// * `span`: The [`Span`] covering this node
    /// * `decorators`: Decorators on the export declaration (e.g., `@Builder export function ...`)
    ...
    /// * `with_clause`: Some(vec![]) for empty assertion
    #[inline]
    pub fn new_with_decorators<B: GetAstBuilder<'a>, T1, T2>(
        span: Span,
        decorators: ArenaVec<'a, Decorator<'a>>,
        declaration: Option<Declaration<'a>>,
        specifiers: T1,
    ...
    ///
    /// Returns a [`Box`](ArenaBox) containing the newly-allocated node.
    /// If you want a stack-allocated node, use [`ExportNamedDeclaration::new_with_decorators`] instead.
    ///
    /// ## Parameters
    /// * `span`: The [`Span`] covering this node
    /// * `decorators`: Decorators on the export declaration (e.g., `@Builder export function ...`)
    ...
    /// * `with_clause`: Some(vec![]) for empty assertion
    #[inline]
    pub fn boxed_with_decorators<B: GetAstBuilder<'a>, T1, T2>(
        span: Span,
        decorators: ArenaVec<'a, Decorator<'a>>,
        declaration: Option<Declaration<'a>>,
        specifiers: T1,
...
impl<'a> ExportDefaultDeclarationKind<'a> {
    ...
    /// Build an [`ExportDefaultDeclarationKind::FunctionExpression`] with `decorators`.
    ///
    /// This node contains a [`Function`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build an [`ExportDefaultDeclarationKind::FunctionExpression`] with `scope_id` and `pure` and `pife` and `decorators`.
    ///
    /// This node contains a [`Function`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build an [`ExportDefaultDeclarationKind::ArkUIComponentExpression`].
    ///
    /// This node contains an [`ArkUIComponentExpression`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build an [`ExportDefaultDeclarationKind::LeadingDotExpression`].
    ///
    /// This node contains a [`LeadingDotExpression`] that will be stored in the memory arena.
    ///
    /// ## Parameters
...
impl<'a> JSXExpression<'a> {
    ...
    /// Build a [`JSXExpression::FunctionExpression`] with `decorators`.
    ///
    /// This node contains a [`Function`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build a [`JSXExpression::FunctionExpression`] with `scope_id` and `pure` and `pife` and `decorators`.
    ///
    /// This node contains a [`Function`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build a [`JSXExpression::ArkUIComponentExpression`].
    ///
    /// This node contains an [`ArkUIComponentExpression`] that will be stored in the memory arena.
    ///
    /// ## Parameters
    ...
    /// Build a [`JSXExpression::LeadingDotExpression`].
    ///
    /// This node contains a [`LeadingDotExpression`] that will be stored in the memory arena.
    ///
    /// ## Parameters
...
impl<'a> StructStatement<'a> {
    /// Build a [`StructStatement`].
    ///
    /// If you want the built node to be allocated in the memory arena,
    /// use [`StructStatement::boxed`] instead.
    ///
    /// ## Parameters
    /// * `span`: Span
    /// * `decorators`: Decorators applied to the struct.
    ...
    ///
    /// Returns a [`Box`](ArenaBox) containing the newly-allocated node.
    /// If you want a stack-allocated node, use [`StructStatement::new`] instead.
    ///
    /// ## Parameters
    /// * `span`: Span
    /// * `decorators`: Decorators applied to the struct.
    ...
    ///
    /// If you want the built node to be allocated in the memory arena,
    /// use [`StructStatement::boxed_with_scope_id`] instead.
    ///
    /// ## Parameters
    /// * `span`: Span
    /// * `decorators`: Decorators applied to the struct.
    ...
    ///
    /// Returns a [`Box`](ArenaBox) containing the newly-allocated node.
    /// If you want a stack-allocated node, use [`StructStatement::new_with_scope_id`] instead.
    ///
    /// ## Parameters
    /// * `span`: Span
    /// * `decorators`: Decorators applied to the struct.
...
impl<'a> StructBody<'a> {
    ...
    pub fn new<B: GetAstBuilder<'a>, T1>(span: Span, body: T1, builder: &B) -> Self
    where
        T1: IntoIn<'a, ArenaVec<'a, StructElement<'a>>>,
    {
        let builder = builder.builder();
        StructBody {
            node_id: Cell::new(builder.node_id()),
    ...
    ///
    /// Returns a [`Box`](ArenaBox) containing the newly-allocated node.
    /// If you want a stack-allocated node, use [`StructBody::new`] instead.
    ///
    /// ## Parameters
    /// * `span`: Span
    /// * `body`: Elements within the struct body
...
impl<'a> ArkUIComponentExpression<'a> {
    /// Build an [`ArkUIComponentExpression`].
    ///
    /// If you want the built node to be allocated in the memory arena,
    /// use [`ArkUIComponentExpression::boxed`] instead.
    ///
    /// ## Parameters
    /// * `span`: Span
    /// * `callee`: The component name/callee (e.g., `Column`, `Text`, `Button`)
        ...
        T4: IntoIn<'a, ArenaVec<'a, CallExpression<'a>>>,
    {
        ...
        ArkUIComponentExpression {
            ...
            children: children.into_in(builder.allocator()),
            has_children,
            chain_expressions: chain_expressions.into_in(builder.allocator()),
        }
    }
    ...
    ///
    /// Returns a [`Box`](ArenaBox) containing the newly-allocated node.
    /// If you want a stack-allocated node, use [`ArkUIComponentExpression::new`] instead.
    ///
    /// ## Parameters
    /// * `span`: Span
    /// * `callee`: The component name/callee (e.g., `Column`, `Text`, `Button`)
...
impl<'a> AnnotationDeclaration<'a> {
    /// Build an [`AnnotationDeclaration`].
    ///
    /// If you want the built node to be allocated in the memory arena,
    /// use [`AnnotationDeclaration::boxed`] instead.
    ///
    /// ## Parameters
    /// * `span`: Span
    /// * `decorators`: Decorators applied to the annotation (not used for @interface syntax).
    ...
    ///
    /// Returns a [`Box`](ArenaBox) containing the newly-allocated node.
    /// If you want a stack-allocated node, use [`AnnotationDeclaration::new`] instead.
    ///
    /// ## Parameters
    /// * `span`: Span
    /// * `decorators`: Decorators applied to the annotation (not used for @interface syntax).
    ...
    where
        ...
        T2: IntoIn<'a, ArenaBox<'a, AnnotationBody<'a>>>,
    {
        ArenaBox::new_in(Self::new(span, decorators, id, body, declare, builder), builder.builder())
    }

    /// Build an [`AnnotationDeclaration`] with `scope_id`.
    ///
    /// If you want the built node to be allocated in the memory arena,
    /// use [`AnnotationDeclaration::boxed_with_scope_id`] instead.
    ///
    /// ## Parameters
    /// * `span`: Span
    /// * `decorators`: Decorators applied to the annotation (not used for @interface syntax).
    ...
    ///
    /// Returns a [`Box`](ArenaBox) containing the newly-allocated node.
    /// If you want a stack-allocated node, use [`AnnotationDeclaration::new_with_scope_id`] instead.
    ///
    /// ## Parameters
    /// * `span`: Span
    /// * `decorators`: Decorators applied to the annotation (not used for @interface syntax).
    ...
    {
        ArenaBox::new_in(
            Self::new_with_scope_id(span, decorators, id, body, declare, scope_id, builder),
            builder.builder(),
        )
    }
}
...
impl<'a> AnnotationBody<'a> {
    ...
    ///
    /// If you want the built node to be allocated in the memory arena,
    /// use [`AnnotationBody::boxed`] instead.
    ///
    /// ## Parameters
    /// * `span`: Span
    ...
    ///
    /// Returns a [`Box`](ArenaBox) containing the newly-allocated node.
    /// If you want a stack-allocated node, use [`AnnotationBody::new`] instead.
    ///
    /// ## Parameters
    /// * `span`: Span
    /// * `body`: Elements within the annotation body
