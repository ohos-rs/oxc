...
impl<'a> AstBuilder<'a> {
    ...
    pub fn expression_ark_ui_component<T1>(
        ...
        type_arguments: T1,
        arguments: ArenaVec<'a, Argument<'a>>,
        children: ArenaVec<'a, ArkUIChild<'a>>,
        has_children: bool,
        chain_expressions: ArenaVec<'a, CallExpression<'a>>,
    ) -> Expression<'a>
    where
        T1: IntoIn<'a, Option<ArenaBox<'a, TSTypeParameterInstantiation<'a>>>>,
    {
    ...
    pub fn alloc_leading_dot_expression<T1>(
        ...
        arguments: ArenaVec<'a, Argument<'a>>,
        expression: Expression<'a>,
    ) -> ArenaBox<'a, LeadingDotExpression<'a>>
    where
        T1: IntoIn<'a, Option<ArenaBox<'a, TSTypeParameterInstantiation<'a>>>>,
    {
        ArenaBox::new_in(
    ...
    where
        T1: IntoIn<'a, Option<ArenaBox<'a, TSTypeParameterDeclaration<'a>>>>,
        T2: IntoIn<'a, Option<ArenaBox<'a, TSTypeParameterInstantiation<'a>>>>,
        T3: IntoIn<'a, ArenaBox<'a, StructBody<'a>>>,
    {
    ...
    where
        T1: IntoIn<'a, ArenaBox<'a, AnnotationBody<'a>>>,
    {
    ...
    pub fn alloc_lazy_import_declaration<T1>(
        ...
        source: StringLiteral<'a>,
        with_clause: T1,
    ) -> ArenaBox<'a, LazyImportDeclaration<'a>>
    where
        T1: IntoIn<'a, Option<ArenaBox<'a, WithClause<'a>>>>,
    {
        ArenaBox::new_in(self.lazy_import_declaration(span, specifiers, source, with_clause), &self)
    }
    ...
    #[inline]
    pub fn struct_body(self, span: Span, body: ArenaVec<'a, StructElement<'a>>) -> StructBody<'a> {
        StructBody { node_id: Default::default(), span, body }
    }
    ...
    pub fn alloc_struct_body(
        self,
        span: Span,
        body: ArenaVec<'a, StructElement<'a>>,
    ) -> ArenaBox<'a, StructBody<'a>> {
        ArenaBox::new_in(self.struct_body(span, body), &self)
    }
    ...
    pub fn alloc_ark_ui_component_expression<T1>(
        ...
        has_children: bool,
        chain_expressions: ArenaVec<'a, CallExpression<'a>>,
    ) -> ArenaBox<'a, ArkUIComponentExpression<'a>>
    where
        T1: IntoIn<'a, Option<ArenaBox<'a, TSTypeParameterInstantiation<'a>>>>,
    {
        ArenaBox::new_in(
    ...
    where
        T1: IntoIn<'a, ArenaBox<'a, AnnotationBody<'a>>>,
    {
        ArenaBox::new_in(self.annotation_declaration(span, decorators, id, body, declare), &self)
    }
    ...
    pub fn annotation_body(
        ...
        AnnotationBody { node_id: Default::default(), span, body }
    }
