...
impl<'a> AstKind<'a> {
    ...
    pub fn as_module_declaration_kind(&self) -> Option<ModuleDeclarationKind<'a>> {
        match self {
            ...
            Self::LazyImportDeclaration(decl) => Some(ModuleDeclarationKind::LazyImport(decl)),
    ...
    pub fn from_expression(e: &'a Expression<'a>) -> Self {
        match e {
            ...
            Expression::LeadingDotMemberExpression(e) => Self::LeadingDotMemberExpression(e),
...
impl AstKind<'_> {
    ...
    pub fn debug_name(&self) -> std::borrow::Cow<'_, str> {
        ...
        match self {
            ...
            Self::LeadingDotMemberExpression(_) => "LeadingDotMemberExpression".into(),
            ...
            Self::LazyImportDeclaration(_) => "LazyImportDeclaration".into(),
...
pub enum ModuleDeclarationKind<'a> {
    ...
    /// A lazy import declaration like `import lazy { c } from './C'` (ArkUI)
    LazyImport(&'a LazyImportDeclaration<'a>),
...
impl GetSpan for ModuleDeclarationKind<'_> {
    fn span(&self) -> Span {
        match self {
            ...
            Self::LazyImport(decl) => decl.span,
...
impl GetAddress for ModuleDeclarationKind<'_> {
    ...
    fn address(&self) -> Address {
        match *self {
            ...
            Self::LazyImport(decl) => decl.unstable_address(),
