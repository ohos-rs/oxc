...
impl<'a> Format<'a, JsFormatContext<'a>> for AstNode<'a, Vec<'a, StructElement<'a>>> {
    fn fmt(&self, f: &mut JsFormatter<'_, 'a>) {
...
impl<'a> Format<'a, JsFormatContext<'a>> for AstNode<'a, Vec<'a, AnnotationElement<'a>>> {
    fn fmt(&self, f: &mut JsFormatter<'_, 'a>) {
...
impl<'a> Format<'a, JsFormatContext<'a>> for AstNode<'a, Vec<'a, ArkUIChild<'a>>> {
    fn fmt(&self, f: &mut JsFormatter<'_, 'a>) {
        let mut join = f.join_nodes_with_hardline();
