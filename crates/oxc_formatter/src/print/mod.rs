...
/// Check whether an object-literal value is an ArkUI leading-dot expression,
/// including a member/call chain rooted at one.
...
impl<'a> Format<'a, JsFormatContext<'a>> for AstNode<'a, ArenaVec<'a, StructElement<'a>>> {
    fn fmt(&self, f: &mut JsFormatter<'_, 'a>) {
...
impl<'a> Format<'a, JsFormatContext<'a>> for AstNode<'a, ArenaVec<'a, AnnotationElement<'a>>> {
    fn fmt(&self, f: &mut JsFormatter<'_, 'a>) {
...
impl<'a> Format<'a, JsFormatContext<'a>> for FormatStructElementWithSemicolon<'a, '_> {
    fn fmt(&self, f: &mut JsFormatter<'_, 'a>) {
...
impl<'a> Format<'a, JsFormatContext<'a>>
    for (&AstNode<'a, StructElement<'a>>, Option<&AstNode<'a, StructElement<'a>>>)
{
    fn fmt(&self, f: &mut JsFormatter<'_, 'a>) {
...
impl<'a> Format<'a, JsFormatContext<'a>> for FormatAnnotationElementWithSemicolon<'a, '_> {
    fn fmt(&self, f: &mut JsFormatter<'_, 'a>) {
...
impl<'a> Format<'a, JsFormatContext<'a>> for FormatArkUIChainExpression<'a, '_> {
    fn fmt(&self, f: &mut JsFormatter<'_, 'a>) {
