...
fn lower_expression<'a>(
    ...
    match expr {
        ...
        oxc::Expression::ArkUIComponentExpression(_) | oxc::Expression::LeadingDotExpression(_) => {
            // React Compiler does not lower ArkTS DSL expressions. Skip compilation
            // of the containing function instead of producing incorrect HIR.
...
fn expression_type_name(expr: &oxc::Expression) -> &'static str {
    match expr {
        ...
        oxc::Expression::ArkUIComponentExpression(_) => "ArkUIComponentExpression",
        oxc::Expression::LeadingDotExpression(_) => "LeadingDotExpression",
