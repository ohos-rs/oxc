...
pub trait Traverse<'a, State> {
    ...
    #[inline]
    fn enter_ark_ui_child(&mut self, node: &mut ArkUIChild<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_ark_ui_child(&mut self, node: &mut ArkUIChild<'a>, ctx: &mut TraverseCtx<'a, State>) {}
