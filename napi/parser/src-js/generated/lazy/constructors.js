...
export class LeadingDotExpression {
  ...
  get typeArguments() {
    const internal = this.#internal;
    return constructOptionBoxTSTypeParameterInstantiation(internal.pos + 16, internal.ast);
  }
...
export class Function {
  ...
  get type() {
    const internal = this.#internal;
    return constructFunctionType(internal.pos + 112, internal.ast);
  }
  ...
  get generator() {
    const internal = this.#internal;
    return constructBool(internal.pos + 113, internal.ast);
  }

  get async() {
    const internal = this.#internal;
    return constructBool(internal.pos + 114, internal.ast);
  }
...
export class ExportNamedDeclaration {
  ...
  get declaration() {
    const internal = this.#internal;
    return constructOptionDeclaration(internal.pos + 40, internal.ast);
  }
  ...
  get specifiers() {
    const internal = this.#internal,
      cached = internal.$specifiers;
    if (cached !== void 0) return cached;
    return (internal.$specifiers = constructVecExportSpecifier(internal.pos + 56, internal.ast));
  }

  get source() {
    const internal = this.#internal;
    return constructOptionStringLiteral(internal.pos + 80, internal.ast);
  }
...
export class StructBody {
  ...
  get body() {
    const internal = this.#internal,
      cached = internal.$body;
    if (cached !== void 0) return cached;
    return (internal.$body = constructVecStructElement(internal.pos + 16, internal.ast));
  }
...
export class ArkUIComponentExpression {
  ...
  get children() {
    const internal = this.#internal,
      cached = internal.$children;
    if (cached !== void 0) return cached;
    return (internal.$children = constructVecArkUIChild(internal.pos + 64, internal.ast));
  }
...
export class AnnotationDeclaration {
  ...
  get body() {
    const internal = this.#internal;
    return constructBoxAnnotationBody(internal.pos + 72, internal.ast);
  }
...
export class AnnotationBody {
  ...
  get body() {
    const internal = this.#internal,
      cached = internal.$body;
    if (cached !== void 0) return cached;
    return (internal.$body = constructVecAnnotationElement(internal.pos + 16, internal.ast));
  }
...
function constructBoxArkUIComponentExpression(pos, ast) {
  return new ArkUIComponentExpression(ast.buffer.int32[pos >> 2], ast);
}
...
function constructBoxStructStatement(pos, ast) {
  return new StructStatement(ast.buffer.int32[pos >> 2], ast);
}
...
function constructBoxLazyImportDeclaration(pos, ast) {
  return new LazyImportDeclaration(ast.buffer.int32[pos >> 2], ast);
}
...
function constructOptionDeclaration(pos, ast) {
  if (ast.buffer[pos] === 18) return null;
...
function constructVecStructElement(pos, ast) {
  const { int32 } = ast.buffer,
    pos32 = pos >> 2;
  return new NodeArray(int32[pos32], int32[pos32 + 2], 16, constructStructElement, ast);
}

function constructVecArkUIChild(pos, ast) {
  const { int32 } = ast.buffer,
    pos32 = pos >> 2;
  return new NodeArray(int32[pos32], int32[pos32 + 2], 16, constructArkUIChild, ast);
}

function constructVecCallExpression(pos, ast) {
  const { int32 } = ast.buffer,
    pos32 = pos >> 2;
  return new NodeArray(int32[pos32], int32[pos32 + 2], 64, constructCallExpression, ast);
}
...
function constructBoxStatement(pos, ast) {
  return constructStatement(ast.buffer.int32[pos >> 2], ast);
}

function constructBoxAnnotationBody(pos, ast) {
  return new AnnotationBody(ast.buffer.int32[pos >> 2], ast);
}
