...
function deserializeFunction(pos) {
  let start,
    ...
    node = (parent = {
      ...
      declare: deserializeBool(pos + 111),
      typeParameters: null,
      params: null,
      returnType: null,
      body: null,
  ...
  {
    let thisParam = deserializeOptionBoxTSThisParameter(pos + 72);
  ...
  node.params = params;
  node.returnType = deserializeOptionBoxTSTypeAnnotation(pos + 88);
...
function deserializeBoxLeadingDotExpression(pos) {
  return deserializeLeadingDotExpression(uint32[pos >> 2]);
}
